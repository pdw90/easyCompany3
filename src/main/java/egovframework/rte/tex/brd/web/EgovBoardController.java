...
public class EgovBoardController {
	...
	public String insertPageBoard(@ModelAttribute("searchVO") SearchVO searchVO, Model model) throws Exception {
	...
	public String updtPageBoard(@RequestParam("selectedId") String id, @ModelAttribute("searchVO") SearchVO searchVO, Model model) throws Exception {
	...
	public String deleteBoard(BoardVO boardVO, @ModelAttribute("searchVO") SearchVO searchVO, SessionStatus status) throws Exception {
	...
	public String insertBoard(@ModelAttribute("searchVO") SearchVO searchVO, BoardVO boardVO, BindingResult bindingResult, Model model, SessionStatus status) throws Exception {
	...
	public String updateBoard(@ModelAttribute("searchVO") SearchVO searchVO, BoardVO boardVO, BindingResult bindingResult, Model model, SessionStatus status) throws Exception {
