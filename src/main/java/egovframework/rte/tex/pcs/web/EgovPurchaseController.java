...
public class EgovPurchaseController {
	...
	public String selectCartList(@ModelAttribute("searchVO") SearchVO searchVO, ModelMap model) throws Exception {
		...
		List<CartVO> cartList = egovCartService.selectCartList(cartVO);
	...
	public String insertCart(@RequestParam("selectedId") String goodsId, @RequestParam("qy") int qy, @ModelAttribute("searchVO") SearchVO searchVO, Model model) throws Exception {
		CartVO cartVO = new CartVO();
	...
	public String insertPurchaseFromCart(@RequestParam("cart_col_check[]") String[] ckd) throws Exception {
	...
	public String insertPurchase(@RequestParam("selectedId") String goodsId, @RequestParam("qy") int qy, @ModelAttribute("searchVO") SearchVO searchVO, Model model)
			throws Exception {
