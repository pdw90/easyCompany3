...
public class PurchaseVO extends SearchVO {
	 ...
	 * @param dlvySe 납품상태
	 */
	public PurchaseVO(String purchsId, GoodsVO goodsVO, String mberNo, int qy, String purchsDe, String dlvySe) {
		super();
	...
	public String toString() {
		return "PurchaseVO [purchsId=" + purchsId + ", goodsVO=" + goodsVO + ", mberNo=" + mberNo + ", qy=" + qy + ", purchsDe=" + purchsDe + ", dlvySe=" + dlvySe + "]";
	}
}