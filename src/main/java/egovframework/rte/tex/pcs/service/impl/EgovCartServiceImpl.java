 ...
 */
@Service("cartService")
public class EgovCartServiceImpl extends EgovAbstractServiceImpl implements EgovCartService {

	private static final Logger LOGGER = LoggerFactory.getLogger(EgovCartServiceImpl.class);
