...
public class EgovPurchaseServiceImpl extends EgovAbstractServiceImpl implements EgovPurchaseService{
	
	private static final Logger LOGGER = LoggerFactory.getLogger(EgovPurchaseServiceImpl.class);
