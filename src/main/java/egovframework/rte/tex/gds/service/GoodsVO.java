...
public class GoodsVO extends SearchVO {
	 ...
	 * @param makr 제조사명
	 */
	public GoodsVO(String goodsId, String goodsNm, int price, GoodsImageVO goodsImageVO, CategoryVO categoryVO, GoodsImageVO detailImageVO, String makr) {
		super();
	...
	public String toString() {
		return "GoodsVO [goodsId=" + goodsId + ", goodsNm=" + goodsNm + ", price=" + price + ", goodsImageVO=" + goodsImageVO + ", categoryVO=" + categoryVO + ", detailImageVO="
