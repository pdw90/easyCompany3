...
public class EgovGoodsServiceImpl extends EgovAbstractServiceImpl implements EgovGoodsService {

	private static final Logger LOGGER = LoggerFactory.getLogger(EgovGoodsServiceImpl.class);
