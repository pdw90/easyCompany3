...
public class EgovGoodsController {
	...
	public String selectGoodsList(@ModelAttribute("searchVO") SearchVO searchVO, ModelMap model) throws Exception {
	...
	public String insertGoods(final HttpServletRequest request, @ModelAttribute("searchVO") SearchVO searchVO, GoodsVO goodsVO, BindingResult bindingResult, Model model,
	...
	public String insertGoodsView(@ModelAttribute("searchVO") SearchVO searchVO, Model model) throws Exception {
	...
	public @ModelAttribute("goodsVO") GoodsVO selectGoods(GoodsVO goodsVO, @ModelAttribute("searchVO") SearchVO searchVO) throws Exception {
	...
	public String getGoodsView(@RequestParam("selectedId") String goodsId, @ModelAttribute("searchVO") SearchVO searchVO, Model model) throws Exception {
	...
	public String updateGoodsView(@RequestParam("selectedId") String goodsId, @ModelAttribute("searchVO") SearchVO searchVO, Model model) throws Exception {
		GoodsVO goodsVO = new GoodsVO();
	...
	public String updateGoods(final HttpServletRequest request, @ModelAttribute("searchVO") SearchVO searchVO, GoodsVO goodsVO, BindingResult bindingResult, Model model,
			SessionStatus status) throws Exception {
		// Server-Side Validation
		beanValidator.validate(goodsVO, bindingResult);
	...
	public String deleteGoods(GoodsVO goodsVO, HttpServletRequest request, @ModelAttribute("searchVO") SearchVO searchVO, SessionStatus status) throws Exception {
