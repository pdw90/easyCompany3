...
public class DeliveryDAO extends EgovAbstractDAO {
	...
	public List<PurchaseVO> selectPurchaseList(PurchaseVO purchaseVO) throws Exception {
		...
		return (List<PurchaseVO>) list("deliveryDAO.selectPurchaseList", purchaseVO);
	}
	...
	public List<PurchaseVO> selectAllPurchaseList(PurchaseVO purchaseVO) throws Exception {
		return (List<PurchaseVO>) list("deliveryDAO.selectAllPurchaseList", purchaseVO);
	}
	...
	public List<PurchaseVO> selectAllPurchaseXml() throws Exception {
		return (List<PurchaseVO>) list("deliveryDAO.selectAllPurchaseXml", new PurchaseVO());
	}
	...
	public int selectGoodsListTotCnt(PurchaseVO purchaseVO) throws Exception {
		return (Integer) select("deliveryDAO.selectDeleveryInfoListTotCnt", purchaseVO);
	}
	...
	public int selectAllGoodsListTotCnt(PurchaseVO purchaseVO) throws Exception {
		return (Integer) select("deliveryDAO.selectAllDeleveryInfoListTotCnt", purchaseVO);
	}
}
