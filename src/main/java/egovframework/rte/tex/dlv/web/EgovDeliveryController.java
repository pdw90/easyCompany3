...
public class EgovDeliveryController {
	...
	public String selectPurchaseList(@ModelAttribute("searchVO") SearchVO searchVO, ModelMap model) throws Exception {
	...
	public String selectAllPurchaseList(@ModelAttribute("searchVO") SearchVO searchVO, ModelMap model, HttpServletRequest request) throws Exception {
