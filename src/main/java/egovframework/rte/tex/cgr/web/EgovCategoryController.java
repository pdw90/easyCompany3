...
public class EgovCategoryController {
	...
	public String selectCategoryList(HttpServletRequest request, Model model) throws Exception {
		...
		if ("popup".equals(request.getParameter("name")))
			return "cgr/EgovCategoryPopup";
		else
			return "cgr/egovCategoryList";
	}
	...
	public String create(@Valid CategoryVO categoryVO, BindingResult results, HttpSession session, Model model) throws Exception {
	...
	public String update(@Valid CategoryVO updateCategory, BindingResult results, Model model) throws Exception {
		if (results.hasErrors()) {
			return "cgr/egovCategoryRegister";
		}
