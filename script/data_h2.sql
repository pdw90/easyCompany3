...
insert into RTETNMBER(MBER_NO,MBER_ID,NM,PASSWORD,EMAIL,TELNO,MBTLNUM,DETAIL_ADRES,LAST_CHANGE_DT,MNGR_SE,ZIP,ADRES) values ('MEMBER-0000000000001','admin','관리자','21232f297a57a5a743894a0e4a801fc3','admin@easyCompany2.com','070-777-7777','010-123-4567','','2011-08-26','CODE01','134000','서울시 송파구 풍납동');
insert into RTETNMBER(MBER_NO,MBER_ID,NM,PASSWORD,EMAIL,TELNO,MBTLNUM,DETAIL_ADRES,LAST_CHANGE_DT,MNGR_SE,ZIP,ADRES) values ('MEMBER-0000000000002','user','일반사용자','ee11cbb19052e40b07aac0ca060c23ee','user@easyCompany2.com','02-413-0000','010-987-6543','','2011-08-26','CODE02','111111','서울시 중구 무교동');
